...
Public Class FormMitsumoriBuhinSearch
    Inherits Form

    Private label As New Label() With {.Text = "見積番号", .Left = 20, .Top = 20, .AutoSize = True}
    Private txtMitsumori As New TextBox() With {.Left = 80, .Top = 18, .Width = 200}
    ...
    Public Sub New()
        ...
        Me.Width = 560
        Me.Height = 380
        Me.Controls.AddRange({label, txtMitsumori, btnSearch, btnClear, dgvResult})
        AddHandler btnSearch.Click, AddressOf BtnSearch_Click
        AddHandler btnClear.Click, AddressOf BtnClear_Click
    End Sub

    Private Sub FormMitsumoriBuhinSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' 初期表示時の処理
    ...
    Private Async Sub BtnSearch_Click(sender As Object, e As EventArgs)
        Dim param As New MitsumoriBuhinSearchParam With {.MitsumoriCode = txtMitsumori.Text}
        Try
            Dim result = Await HttpClientWrapper.PostAsync(Of MitsumoriBuhinSearchResult)("MitsumoriBuhinApi/search", param)
